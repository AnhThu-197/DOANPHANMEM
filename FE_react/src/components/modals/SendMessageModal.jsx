        ...
        <form onSubmit={handleSendMessage}>
          ...
          >
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (selectedCust) {
                      ...
                      if (
                        selectedCust.trialStartDate &&
                        selectedCust.trialDays > 0
                      ) {
                        const start = new Date(selectedCust.trialStartDate);

                        const end = new Date(
                          start.getTime() +
                            selectedCust.trialDays *
                              24 *
                              60 *
                              60 *
                              1000
            ...
            >
              ...
              >
                Chọn mẫu để tự động điền nội dung và
                kênh gửi mặc định
              </small>
            </div>
            ...
            >
              ...
              >
                <div className="form-group">
                  <label>
                    Tiêu đề chương trình KM
                  </label>

                  <input
                    type="text"
                    className="form-control"
                    placeholder="VD: Tri ân khách hàng tháng 5"
                    value={sendForm.promoTitle || ''}
                    onChange={(e) =>
                      setSendForm({
                        ...sendForm,
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    placeholder="VD: CRMVOUCHER10"
                    value={sendForm.promoCode || ''}
                    onChange={(e) =>
                      setSendForm({
                        ...sendForm,
              ...
              >
                <div className="form-group">
                  ...
                  <input
                    type="date"
                    className="form-control"
                    value={sendForm.promoExpiry || ''}
                    onChange={(e) =>
                      setSendForm({
                        ...sendForm,
                        promoExpiry: e.target.value
                      })
                    }
                  />
                </div>
            ...
            >
              ...
              >
                <input
                  type="checkbox"
                  checked={
                    sendForm.trackOpen || false
                  }
                  onChange={(e) =>
                    setSendForm({
                      ...sendForm,
                      trackOpen: e.target.checked
                    })
                  }
                />
